 ...
 * @author pc
 */
@WebServlet(name = "Cookies", urlPatterns = {"/Cookies.do"})
public class Cookies extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter())  {
            ...
            if (lastVisit != null)
                out.println("Twoja ostatnia wizyta na stronie miala miejsce w dniu: " + login + lastVisit.getValue());
            else {
                out.println("To Twoja pierwsza wizyta " + login);                
            }
